          ...
          <AnimatePresence mode="popLayout">
            {filtered.map((p, i) => (
              <motion.div
                ...
                className={`relative group cursor-pointer overflow-hidden aspect-[4/5] glass transition-all duration-500 ${
                  selected === p.id ? "ring-2 ring-gold/40 scale-[1.02]" : "hover:ring-1 hover:ring-gold/20"
                }`}
              >
                <img
                  src={p.src}
